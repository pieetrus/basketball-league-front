...
const PlayerSeasonStatsTable: React.FC = () => {
  const rootStore = useContext(RootStoreContext);
  const { playersSeason } = rootStore.playerStore;

  const makeData = () => {
    let data = playersSeason.map((player) => ({
...
export default observer(PlayerSeasonStatsTable);
