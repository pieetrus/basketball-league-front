...
const TeamSeasonStatsTable: React.FC = () => {
  const rootStore = useContext(RootStoreContext);
  const { teamsSeasonByName } = rootStore.teamStore;

  const makeData = () => {
    let data = teamsSeasonByName.map((team) => ({
      season: team.season,
...
export default observer(TeamSeasonStatsTable);
